...
async def remediate_bulk(
    ...
    try:
        ...
        for f_data in findings_data:
            ...
            fix_snippet = RemediationEngine.generate_fix(finding_obj)
            ...
            if finding_obj.evidence and patched_code:
                with open(new_file_abs, "r", encoding="utf-8") as file_read:
                    content = file_read.read()
                
                # Replace the exact evidence string
                content = content.replace(finding_obj.evidence, patched_code)

...
def call_ollama(prompt: str) -> str:
    ...
    # Force the LLM to output ONLY code
    strict_prompt = prompt + (
        "\n\nCRITICAL INSTRUCTION: You are an expert security engineer. You must return ONLY the complete, patched source code file. "
        "Do NOT include any conversational text, explanations, or markdown formatting blocks (e.g. no ```python). "
        "Just return the raw source code. Your entire response will be written directly to the file."
    )

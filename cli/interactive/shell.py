...
def _print_help():
    ...
    sections = [
        ...
        ("── Remediation ──────────────────────────────────────────────────", ""),
        ("remediation plan",          "Generate AI fix plan for all findings"),
        ("remediation preview",       "Preview code diffs before applying"),
        ("remediation apply",         "Apply patches to source files"),
        ("remediation rollback",      "Restore original files from backup"),
        ("── Validation & Reports ─────────────────────────────────────────", ""),
